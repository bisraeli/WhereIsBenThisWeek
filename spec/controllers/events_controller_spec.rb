...
describe EventsController do
  ...
  let(:valid_attributes) { { "external_id" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved event as @event" do
        ...
        post :create, {:event => { "external_id" => "invalid value" }}, valid_session
        assigns(:event).should be_a_new(Event)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested event" do
        ...
        Event.any_instance.should_receive(:update).with({ "external_id" => "MyString" })
        put :update, {:id => event.to_param, :event => { "external_id" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the event as @event" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Event.any_instance.stub(:save).and_return(false)
        put :update, {:id => event.to_param, :event => { "external_id" => "invalid value" }}, valid_session
        assigns(:event).should eq(event)
      end
